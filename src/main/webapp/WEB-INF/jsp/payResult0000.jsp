...
<body style="background: #eee;">
	...
	<div class="box" style="text-align: center;margin-top: 50px;">
		<img style="width: 100px;height: 100px;" src="./pay_icon01.png" alt="非法授权码!" />
		<img style="width: 100px;height: 100px;" src="./pay_icon02.png" alt="非法授权码!" />
		<p style="font-size:18px;margin-top: 20px;">无效的授权码，该系统目前仅支持微信和支付宝支付，其他渠道敬请期待！</p>
	</div>
</body>
</html>